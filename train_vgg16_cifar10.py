...
misc.logger.init(args.logdir, 'log_2021_3_8')
print = misc.logger.info
os.makedirs('vgg16_models3-5', exist_ok=True)
...
num_classes = 10
train_dataset=datasets.CIFAR10(root=r'c:\data\tv',train=True,transform=transform_train,download=True)
test_dataset=datasets.CIFAR10(root=r'c:\data\tv',train=False,transform=transform_test)
...
if args.epoch_ != 0:
    ...
    model.load_state_dict(torch.load('vgg16_models3-5/model_60.pth'))
else:
...
for epoch in range(args.n_epochs):
    ...
    if epoch % 10 == 0:
        torch.save(model.state_dict(), 'vgg16_models3-5/model_%d.pth' % epoch)
