...
misc.logger.init(args.logdir, 'log_2021_3_12_senet')
print = misc.logger.info
os.makedirs('senet_models3-12', exist_ok=True)
...
if args.epoch_ != 0:
    ...
    model = senet.Senet()
    print(">>>>loading model........<<<<")
    model.load_state_dict(torch.load('senet_models3-12/model_50.pth'))
else:
    model = senet.Senet()
...
for epoch in range(args.n_epochs):
    ...
    if epoch % 10 == 0:
        torch.save(model.state_dict(), 'senet_models3-12/model_%d.pth' % epoch)