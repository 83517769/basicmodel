...
misc.logger.init(args.logdir, 'log_2021_3_12_resnet')
print = misc.logger.info
os.makedirs('resnet_models3-12', exist_ok=True)
...
if args.epoch_ != 0:
    ...
    model = resnet_all.resnet34(pretrained=False)
    ...
    model = resnet_all.resnet34(pretrained=True,model_root=args.logdir)
...
for epoch in range(args.n_epochs):
    ...
    if epoch % 10 == 0:
        torch.save(model.state_dict(), 'resnet_models3-12/model_%d.pth' % epoch)